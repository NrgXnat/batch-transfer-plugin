console.log('BatchTransferPlugin: activityMonitoring.js');
...
(function(factory){
    ...
    XNAT.plugin.batchtransfer.updateBatchTransferProgress = function(itemDivId, detailsTag, jsonobj, lastProgressIdx) {
